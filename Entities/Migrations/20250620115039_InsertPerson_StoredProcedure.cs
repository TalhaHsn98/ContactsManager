    ...
    public partial class InsertPerson_StoredProcedure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string sp_InsertPerson = @"
                ...
                @Email nvarchar(50), @DateOfBirth datetime2(7), @Gender
                varchar(10), @CountryID uniqueidentifier, @Address nvarchar(1000),
                ...
                AS BEGIN 
                    ...
                    VALUES (@PersonID, @PersonName, @Email, @DateOfBirth, @Gender,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            string sp_InsertPersons = @"DROP PROCEDURE [dbo].[GetAllPersons]";
